import * as shared from '../entries/pages/(app)/auth/_layout.ts.js';

export const index = 3;
export const component = async () => (await import('../entries/pages/(app)/auth/_layout@.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/auth/_layout@.svelte-61cd6135.js';
export { shared };
...
export const stylesheets = ["_app/immutable/assets/FlatToast-4da694a0.css","_app/immutable/assets/PageTransitions-bc777b27.css","_app/immutable/assets/PreloadingIndicator-6be07759.css"];
