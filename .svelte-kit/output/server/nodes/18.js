import * as server from '../entries/pages/(app)/my/_page.server.ts.js';

export const index = 18;
export const component = async () => (await import('../entries/pages/(app)/my/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/my/_page.svelte-43f284ae.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/MobileFooter-2e009648.css"];
