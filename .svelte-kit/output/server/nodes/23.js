import * as server from '../entries/pages/(app)/my/profile/_page.server.ts.js';

export const index = 23;
export const component = async () => (await import('../entries/pages/(app)/my/profile/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/my/profile/_page.svelte-5c11af3a.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/_page-9e079fe8.css","_app/immutable/assets/FlatToast-4da694a0.css","_app/immutable/assets/Skeleton-12b4362d.css"];
