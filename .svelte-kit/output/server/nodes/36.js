...
export const component = async () => (await import('../entries/pages/(marketing)/p/payments-returns/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(marketing)/p/payments-returns/_page.svelte-219032bc.js';
