import * as server from '../entries/pages/(app)/my/addresses/_page.server.ts.js';

export const index = 19;
export const component = async () => (await import('../entries/pages/(app)/my/addresses/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/my/addresses/_page.svelte-0e666f27.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/_page-9874917c.css","_app/immutable/assets/PrimaryButton-5dcaa620.css","_app/immutable/assets/ToggleSwitch-c705fe5b.css","_app/immutable/assets/Pagination-4c3425dd.css"];
