import * as server from '../entries/pages/(app)/my/orders/_page.server.ts.js';

export const index = 21;
export const component = async () => (await import('../entries/pages/(app)/my/orders/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/my/orders/_page.svelte-657bffcd.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/_page-66d643fa.css","_app/immutable/assets/FlatToast-4da694a0.css","_app/immutable/assets/PrimaryButton-5dcaa620.css","_app/immutable/assets/Pagination-4c3425dd.css"];
