...
export const component = async () => (await import('../entries/pages/(marketing)/p/terms-conditions/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(marketing)/p/terms-conditions/_page.svelte-4c75876b.js';
