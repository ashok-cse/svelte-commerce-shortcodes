import * as shared from '../entries/pages/(app)/autosuggest/_page.ts.js';

export const index = 10;
export const component = async () => (await import('../entries/pages/(app)/autosuggest/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/autosuggest/_page.svelte-fae3fe03.js';
export { shared };
