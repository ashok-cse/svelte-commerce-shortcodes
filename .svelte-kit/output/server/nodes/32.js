import * as server from '../entries/pages/(app)/shop/_slug_/_page.server.ts.js';

export const index = 32;
export const component = async () => (await import('../entries/pages/(app)/shop/_slug_/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/shop/_slug_/_page.svelte-b9774f2f.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/MobileFooter-2e009648.css","_app/immutable/assets/PrimaryButton-5dcaa620.css"];
