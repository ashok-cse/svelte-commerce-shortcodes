import * as server from '../entries/pages/(app)/my/wishlist/_page.server.ts.js';

export const index = 26;
export const component = async () => (await import('../entries/pages/(app)/my/wishlist/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/my/wishlist/_page.svelte-88b47281.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/_page-ce1d138d.css","_app/immutable/assets/MobileFooter-2e009648.css","_app/immutable/assets/PrimaryButton-5dcaa620.css"];
