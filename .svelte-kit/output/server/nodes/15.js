import * as server from '../entries/pages/(app)/checkout/add-address/_page.server.ts.js';

export const index = 15;
export const component = async () => (await import('../entries/pages/(app)/checkout/add-address/_page.svelte.js')).default;
export const file = '_app/immutable/components/pages/(app)/checkout/add-address/_page.svelte-c5d05a2a.js';
export { server };
...
export const stylesheets = ["_app/immutable/assets/FlatToast-4da694a0.css","_app/immutable/assets/PrimaryButton-5dcaa620.css"];
